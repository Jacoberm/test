...
//       image and occupy addresses 0x00000400 to 0x0000040f.
...
typedef volatile struct cyghwr_hal_kinetis_flexcan_s {
    cyg_uint32 mcr;                    // Module Configuration Register
    cyg_uint32 ctrl1;                  // Control 1 Register
    cyg_uint32 timer;                  // Free Running Register
    cyg_uint32 rxmgmask;               // Rx Mailboxes Global Register
    cyg_uint32 rx14mask;               // Rx 14 Mask register Register
    cyg_uint32 rx15mask;               // Rx 15 Mask Register
    cyg_uint32 ecr;                    // Error Counter Register
    cyg_uint32 esr1;                   // Error and Status 1 Register
    cyg_uint32 imask1;                 // Interrupt Masks 1 Register
    cyg_uint32 iflag1;                    // Interrupt Flags 1 Register
    cyg_uint32 ctrl2;                   // Control 2 Register
    cyg_uint32 esr2;                   // Error and Status 2 Register
    cyg_uint32 ercr;                    //CRC Register Register
    cyg_uint32 rxfgmask;                // Rx FIFO Global Mask Register
    cyg_uint32 rxfir;                    // Rx FIFO Information Register
    cyg_uint32 rximrn;                    // Rx Individual Mask Register
} cyghwr_hal_kinetis_flexcan_t;

#define CYGHWR_HAL_KINETIS_FLEXCANA_P   ((cyghwr_hal_kinetis_flexcan_t *)0x40024000)
#define CYGHWR_HAL_KINETIS_FLEXCANB_P   ((cyghwr_hal_kinetis_flexcan_t *)0x400A4000)
...
typedef volatile struct cyghwr_hal_kinetis_sim_s {
    ...
    cyg_uint32 clk_div3;         // System Clock Divider Register 3
    cyg_uint32 clk_div4;         // System Clock Divider Register 4
...
#define CYGHWR_HAL_KINETIS_SIM_SOPT2_LCDCSRC_M         0xC000000
#define CYGHWR_HAL_KINETIS_SIM_SOPT2_LCDCSRC_S         26
#define CYGHWR_HAL_KINETIS_SIM_SOPT2_LCDCSRC(__val)     \
        VALUE_(CYGHWR_HAL_KINETIS_SIM_SOPT2_LCDCSRC_S, __val)
...
#define CYGHWR_HAL_KINETIS_SIM_SOPT2_NFCSRC_M          0xC0000000
#define CYGHWR_HAL_KINETIS_SIM_SOPT2_NFCSRC_S         30
#define CYGHWR_HAL_KINETIS_SIM_SOPT2_NFCSRC(__val)    \
        VALUE_(CYGHWR_HAL_KINETIS_SIM_SOPT2_NFCSRC_S, __val)
// SOPT4 Bit Fields
...
// CLKDIV4 Bit Fields
#define CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCDIV_M        0xf8000000
#define CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCDIV_S        27
#define CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCDIV(__val)   \
        VALUE_(CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCDIV_S, __val)
#define CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCFRAC_M       0x7000000
#define CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCFRAC_S       24
#define CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCFRAC(__val)   \
        VALUE_(CYGHWR_HAL_KINETIS_SIM_CLKDIV4_NFCFRAC_S, __val)
...
//---------------------------------------------------------------------------
// LCDC - System Lcd Controller Module

// LCDC - Peripheral register structure
typedef volatile struct cyghwr_hal_kinetis_lcdc_s {
    cyg_uint32 lssar;           // Lcdc screen start address register
    cyg_uint32 lsr;           	// Lcdc size register
    cyg_uint32 lvpwr;           // Lcdc virtual page width register
    cyg_uint32 lcpr;           	// Lcdc cursor position register
    cyg_uint32 lcwhb;           // Lcdc cursor width,height,and blink register
    cyg_uint32 lccmr;           // Lcdc color cursor mapping register
    cyg_uint32 lpcr;            // Lcdc panel configuration register
    cyg_uint32 lhcr;           	// Lcdc horizontal configuration Register
    cyg_uint32 lvcr;           	// Lcdc vertical configuration Register
    cyg_uint32 lpor;         	// Lcdc	panning offset register
    cyg_uint32 lpccr;           // Lcdc PWM contrast control register
    cyg_uint32 ldcr;           	// Lcdc DMA control register
    cyg_uint32 lrmcr;           // Lcdc refresh mode control register
    cyg_uint32 licr;           	// Lcdc interrupt configuration register
    cyg_uint32 lier;        	// Lcdc interrupt enable register
    cyg_uint32 lisr;        	// Lcdc interrupt status register
    cyg_uint32 lgwsar;          // Lcdc graphic window start address register
    cyg_uint32 lgwsr;           // Lcdc graphic window size register
    cyg_uint32 lgwvpwr;         // Lcdc graphic birtual page width register
    cyg_uint32 lgwpor;          // Lcdc graphic window panning offset register
    cyg_uint32 lgwpr;           // Lcdc graphic window position register
    cyg_uint32 lgwcr;           // Lcdc graphic window control register

    cyg_uint32 lgwdcr;         	// Lcdc grahpic window DMA control register
    cyg_uint32 lauscr;         	// Lcdc AUS mode control register
    cyg_uint32 lausccr;         // Lcdc AUS mode cursor control register
} cyghwr_hal_kinetis_lcdc_t;

#define CYGHWR_HAL_KINETIS_LCDC_P ((cyghwr_hal_kinetis_lcdc_t *) 0x400b6000)
#define CYGHWR_IO_FREESCALE_LCDC_CLK  CYGHWR_HAL_KINETIS_SIM_SCGC_LCDC
// Lcdc size register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LSR_XMAX_M         0x03F00000
#define CYGHWR_HAL_KINETIS_LCDC_LSR_XMAX_S         20
#define CYGHWR_HAL_KINETIS_LCDC_LSR_XMAX(__val)    \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LSR_XMAX_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LSR_YMAX_M         0x000003FF
#define CYGHWR_HAL_KINETIS_LCDC_LSR_YMAX_S         0
#define CYGHWR_HAL_KINETIS_LCDC_LSR_YMAX(__val)    \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LSR_YMAX_S, __val)
// Lcdc virtual page width register
#define CYGHWR_HAL_KINETIS_LCDC_LVPWR_VPW_M       0x000007FF
#define CYGHWR_HAL_KINETIS_LCDC_LVPWR_VPW_S       0
#define CYGHWR_HAL_KINETIS_LCDC_LVPWR_VPW(__val)    \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LVPWR_VPW_S, __val)

// Lcdc cursor position register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CC_M      0x30000000
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CC_S      30
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CC(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCPR_CC_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_OP_M      0x10000000
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_OP_S      28
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CXP_M      0x03FF0000
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CXP_S      16
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CXP(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCPR_CXP_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CYP_M      0x03FF
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CYP_S      0
#define CYGHWR_HAL_KINETIS_LCDC_LCPR_CYP(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCPR_CYP_S, __val)

// LCDC cursor width, height, and blink register
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_BK_EN_M      0x80000000
#define CYGHWR_HAL_KINETIS_LCDC_SOPT5_BK_EN_S      31
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_CW_M      	0x1F000000
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_CW_S      	24
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_CW(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCWHB_CW_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_CH_M      	0x1F0000
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_CH_S      	16
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_CH(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCWHB_CH_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_BD_M      	0x1F0000
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_BD_S      	16
#define CYGHWR_HAL_KINETIS_LCDC_LCWHB_BD(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCWHB_BD_S, __val)
// LCDC color cursor mapping register
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_R_M       0x3F000
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_R_S       12
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_R(__val)  \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_R_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_G_M       0xFA0
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_G_S       6
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_G(__val)  \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_G_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_B_M       0x3F
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_B_S       0
#define CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_B(__val)  \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LCCMR_CUR_COL_B_S, __val)
// LCDC panel configuration register
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_TFT_M      0x80000000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_TFT_S      31
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_COLOR_M    0x40000000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_COLOR_S    30

#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PBSIZ_M    0x30000000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PBSIZ_S    28
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PBSIZ(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LPCR_PBSIZ_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LPCR_BPIX_M     0xE000000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_BPIX_S     25
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_BPIX(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LPCR_BPIX_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PIXPOL_M   0x1000000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PIXPOL_S   24
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_FLMPOL_M   0x800000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_FLMPOL_S   23
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_LPPOL_M    0x400000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_LPPOL_S    22
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_CLKPOL_M   0x200000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_CLKPOL_S   21
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_OEPOL_M    0x100000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_OEPOL_S    20
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_SCLKIDLE_M   	0x80000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_SCLKIDLE_S   	19
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_END_SEL_M   	0x40000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_END_SEL_S   	18
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_SWAP_SEL_M   	0x20000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_SWAP_SEL_S   	17
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_REV_VS_M   	0x10000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_REV_VS_S   	16
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_ACDSEL_M   	0x8000
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_ACDSEL_S   	15

#define CYGHWR_HAL_KINETIS_LCDC_LPCR_ACD_M     0x7F00
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_ACD_S     8
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_ACD(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LPCR_ACD_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LPCR_SCLKSEL_M   	0x80
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_SCLKSEL_S   	7

#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PCD_M     0x3F
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PCD_S     0
#define CYGHWR_HAL_KINETIS_LCDC_LPCR_PCD(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LPCR_PCD_S, __val)

//LCDC horizontal configuration register
#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WIDTH_M      0xFA000000
#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WIDTH_S      26
#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WIDTH(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WIDTH_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT1_M      0xFF00
#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT1_S      8
#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT1(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT1_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT2_M      0xFF
#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT2_S      0
#define CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT2(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LHCR_H_WAIT2_S, __val)
//LCDC vertical configuration register
#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WIDTH_M      0xFA000000
#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WIDTH_S      26
#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WIDTH(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WIDTH_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT1_M      0xFF00
#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT1_S      8
#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT1(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT1_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT2_M      0xFF
#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT2_S      0
#define CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT2(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LVCR_V_WAIT2_S, __val)

//LCDC panning offset register
#define CYGHWR_HAL_KINETIS_LCDC_LPOR_POS_M      0x1F
#define CYGHWR_HAL_KINETIS_LCDC_LPOR_POS_S  0
#define CYGHWR_HAL_KINETIS_LCDC_LPOR_POS(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LPOR_POS__S, __val)

// Lcdc PWM contrast control register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_LDMSK_M      0x8000
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_LDMSK_S      15
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_SCR_M      0x600
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_SCR_S      9
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_SCR(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LPCCR_SCR_S, __val)
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_CC_EN_M      0x100
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_CC_EN_S      8
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_PW_M      0xFF
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_PW_S      0
#define CYGHWR_HAL_KINETIS_LCDC_LPCCR_PW(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LPCCR_PW_S, __val)

// Lcdc DMA control register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LDCR_BURST_M      0x80000000
#define CYGHWR_HAL_KINETIS_LCDC_LDCR_BURST_S      31

#define CYGHWR_HAL_KINETIS_LCDC_LDCR_HM_M     0x7F0000
#define CYGHWR_HAL_KINETIS_LCDC_LDCR_HM_S    16
#define CYGHWR_HAL_KINETIS_LCDC_LDCR_HM(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LDCR_HM_S, __val)

//#define CYGHWR_HAL_KINETIS_LCDC_LDCR_HM_M      0x7F
//#define CYGHWR_HAL_KINETIS_LCDC_LDCR_HM_S    	0
//#define CYGHWR_HAL_KINETIS_LCDC_LDCR_HM(__val)  VALUE_(CYGHWR_HAL_KINETIS_LCDC_LDCR_HM_S, __val)

// Lcdc refresh mode control register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LRMCR_SELF_REF_M      0x1
#define CYGHWR_HAL_KINETIS_LCDC_LRMCR_SELF_REF_S      0

// Lcdc interrupt configuration register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LICR_GW_INT_CON_M      0x10
#define CYGHWR_HAL_KINETIS_LCDC_LICR_GW_INT_CON_S      4
#define CYGHWR_HAL_KINETIS_LCDC_LICR_INTSYN_M      0x4
#define CYGHWR_HAL_KINETIS_LCDC_LICR_INTSYN_S      2
#define CYGHWR_HAL_KINETIS_LCDC_LICR_INTCON_M      0x1
#define CYGHWR_HAL_KINETIS_LCDC_LICR_INTCON_S      0

// Lcdc interrupt enable register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LIER_GW_UDR_ERR_EN_M      0x80
#define CYGHWR_HAL_KINETIS_LCDC_LIER_GW_UDR_ERR_EN_S      7
#define CYGHWR_HAL_KINETIS_LCDC_LIER_GW_EOF_EN_M      0x20
#define CYGHWR_HAL_KINETIS_LCDC_LIER_GW_EOF_EN_S      5
#define CYGHWR_HAL_KINETIS_LCDC_LIER_GW_BOF_EN_M      0x10
#define CYGHWR_HAL_KINETIS_LCDC_LIER_GW_BOF_EN_S      4
#define CYGHWR_HAL_KINETIS_LCDC_LIER_UDR_ERR_EN_M      0x8
#define CYGHWR_HAL_KINETIS_LCDC_LIER_UDR_ERR_EN_S      3
#define CYGHWR_HAL_KINETIS_LCDC_LIER_EOF_EN_M      0x2
#define CYGHWR_HAL_KINETIS_LCDC_LIER_EOF_EN_S      1
#define CYGHWR_HAL_KINETIS_LCDC_LIER_BOF_EN_M      0x1
#define CYGHWR_HAL_KINETIS_LCDC_LIER_BOF_EN_S      0

// Lcdc interrupt status register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LISR_GW_UDR_ERR_M      0x80
#define CYGHWR_HAL_KINETIS_LCDC_LISR_GW_UDR_ERR_S      7
#define CYGHWR_HAL_KINETIS_LCDC_LISR_GW_EOF_M      0x20
#define CYGHWR_HAL_KINETIS_LCDC_LISR_GW_EOF_S      5
#define CYGHWR_HAL_KINETIS_LCDC_LISR_GW_BOF_M      0x10
#define CYGHWR_HAL_KINETIS_LCDC_LISR_GW_BOF_S      4
#define CYGHWR_HAL_KINETIS_LCDC_LISR_UDR_ERR_M      0x8
#define CYGHWR_HAL_KINETIS_LCDC_LISR_UDR_ERR_S      3
#define CYGHWR_HAL_KINETIS_LCDC_LISR_EOF_M      0x2
#define CYGHWR_HAL_KINETIS_LCDC_LISR_EOF_S      1
#define CYGHWR_HAL_KINETIS_LCDC_LISR_BOF_M      0x1
#define CYGHWR_HAL_KINETIS_LCDC_LISR_BOF_S      0

// Lcdc graphic window start address register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LGWSAR_GWSA_M     0xFFFFFFFA
#define CYGHWR_HAL_KINETIS_LCDC_LGWSAR_GWSA_S    		2
#define CYGHWR_HAL_KINETIS_LCDC_LGWSAR_GWSA(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWSAR_GWSA_S, __val)

// Lcdc graphic window size register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWW_M     0x7F00000
#define CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWW_S    		20
#define CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWW(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWW_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWH_M     0x3FF
#define CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWH_S    		0
#define CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWH(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWSR_GWH_S, __val)

// Lcdc graphic window virtual page width register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LGWVPWR_GWVPW_M     0x7FF
#define CYGHWR_HAL_KINETIS_LCDC_LGWVPWR_GWVPW_S    		0
#define CYGHWR_HAL_KINETIS_LCDC_LGWVPWR_GWVPW(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWVPWR_GWVPW_S, __val)

// Lcdc graphic window panning offset register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LGWPOR_GWPO_M     0x7FF
#define CYGHWR_HAL_KINETIS_LCDC_LGWPOR_GWPO_S    		0
#define CYGHWR_HAL_KINETIS_LCDC_LGWPOR_GWPO(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWPOR_GWPO_S, __val)

// Lcdc graphic window position register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWXP_M     0x3FF0000
#define CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWXP_S     16
#define CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWXP(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWXP_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWYP_M     0x3FF
#define CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWYP_S     0
#define CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWYP(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWPR_GWYP_S, __val)

// Lcdc graphic window control register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWAV_M      0xFF000000
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWAV_S      24
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWAV(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWAV_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKE_M      0x8000000
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKE_S      23
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWE_M      0x400000
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWE_S      22
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GW_RVS_M      0x200000
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GW_RVS_S      21

#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKR_M      0x3F000
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKR_S      12
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKR(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKR_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKG_M      0xFA0
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKG_S      6
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKG(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKG_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKB_M      0x3F
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKB_S      0
#define CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKB(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGWCR_GWCKB_S, __val)

// Lcdc graphic window DMA control register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LGWDCR_GWBT_M      0x80000000
#define CYGHWR_HAL_KINETIS_LCDC_LGDWCR_GWBT_S      31

#define CYGHWR_HAL_KINETIS_LCDC_LGWDCR_GWHM_M      0x7F0000
#define CYGHWR_HAL_KINETIS_LCDC_LGDWCR_GWHM_S      16
#define CYGHWR_HAL_KINETIS_LCDC_LGDWCR_GWHM(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGDWCR_GWHM_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LGWDCR_GWTM_M      0x7F
#define CYGHWR_HAL_KINETIS_LCDC_LGDWCR_GWTM_S      0
#define CYGHWR_HAL_KINETIS_LCDC_LGDWCR_GWTM(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LGDWCR_GWTM_S, __val)
...
// Lcdc AUS mode control register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AUS_MODE_M      0x80000000
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AUS_MODE_S      31

#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKR_M      0xFF0000
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKR_S      16
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKR(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKR_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKG_M      0xFF00
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKG_S      16
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKG(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKG_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKB_M      0xFF
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKB_S      16
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKB(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LAUSCR_AGWCKB_S, __val)

// Lcdc AUS mode cursor control register Bit Fields
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_R_M      0xFF0000
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_R_S      	16
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_R(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_R_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_G_M      0xFF00
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_G_S      	8
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_G(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_G_S, __val)

#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_B_M      0xFF
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_B_S      	0
#define CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_B(__val) \
        VALUE_(CYGHWR_HAL_KINETIS_LCDC_LAUSCCR_ACUR_COL_B_S, __val)
//---------------------------------------------------------------------------
// GPIO
...
//=============================================================================
// DEVS:
// Following macros may also be, and usually are, borrowed by some device
// drivers.
//-----------------------------------------------------------------------------
