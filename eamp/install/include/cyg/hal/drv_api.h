...
#error Driver API requires Kernel API to be present
#endif
...
#define cyg_drv_interrupt_clear_pending     cyg_interrupt_clear_pending
...
externC void cyg_drv_interrupt_clear_pending( cyg_vector_t vector );
