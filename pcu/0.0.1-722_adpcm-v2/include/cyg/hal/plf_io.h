...
#define PECU_LED_G_0_SET(__value) \
		{		\
			if(__value==1)hal_gpio_pin_set( PECU_LED_G0_PIN );\
			else hal_gpio_pin_clear( PECU_LED_G0_PIN );\
		}

#define PECU_LED_G_1_SET(__value1) \
		{		\
			if(__value1==1)hal_gpio_pin_set( PECU_LED_G1_PIN );\
