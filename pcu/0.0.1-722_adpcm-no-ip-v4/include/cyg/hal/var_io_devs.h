...
//-----------------------------------------------------------------------------
// Freescale UART
// Borrow some HAL resources for Freescale UART driver
...
//----------------------------------------------------------------------------
// DSPI
// Lend some HAL dependent macros to the DSPI device driver
...
//----------------------------------------------------------------------------
// eDMA
// Lend some eDMA macros to device drivers that use DMA
...
//----------------------------------------------------------------------------
// flexCAN
#define  CYGADDR_IO_CAN_FREESCALE_FLEXCANA_P  ((cyghwr_devs_freescale_flexcan_t *)0x40024000)
#define  CYGADDR_IO_CAN_FREESCALE_FLEXCANB_P  ((cyghwr_devs_freescale_flexcan_t *)0x400A4000)
#define  CYGHWR_IO_FREESCALE_FLEXCANA_CLOCK CYGHWR_HAL_KINETIS_SIM_SCGC_FLEXCAN0
#define  CYGHWR_IO_FREESCALE_FLEXCANB_CLOCK CYGHWR_HAL_KINETIS_SIM_SCGC_FLEXCAN1
//----------------------------------------------------------------------------
// NFC - NAND Flash controller
#include <cyg/hal/var_io_nfc.h>
//-----------------------------------------------------------------------------
