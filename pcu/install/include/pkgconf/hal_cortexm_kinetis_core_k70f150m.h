...
#define CYGHWR_HAL_FSL_SPIAUDIO_SPI_BUS 0
#define CYGHWR_HAL_FSL_SPIAUDIO_SPI_BUS_0
#define CYGHWR_HAL_FSL_SND_CTRL_SPI_CS 0
#define CYGHWR_HAL_FSL_SND_CTRL_SPI_CS_0
#define CYGHWR_HAL_FSL_SND_PCM_SPI_CS 4
#define CYGHWR_HAL_FSL_SND_PCM_SPI_CS_4
...
#define CYGSEM_HAL_5034_V1_DEVICES_TYPE PECU
#define CYGSEM_HAL_5034_V1_DEVICES_TYPE_PECU
