...
#define EAMP_6W5_2_GAIN1  //CYGHWR_HAL_KINETIS_PIN(D, 11, 1, KINETIS_PIN_PULLUP)   //dac0_out
...
#define PECU_LED0_PIN   CYGHWR_HAL_KINETIS_PIN(E, 18, 1, KINETIS_PIN_PULLUP)
#define PECU_LED1_PIN   CYGHWR_HAL_KINETIS_PIN(E, 19, 1, KINETIS_PIN_PULLUP)

#define PECU_6W5_1_MUTE   CYGHWR_HAL_KINETIS_PIN(D, 11, 1, KINETIS_PIN_PULLUP)
#define PECU_6W5_1_GAIN0  CYGHWR_HAL_KINETIS_PIN(D, 11, 1, KINETIS_PIN_PULLUP)
#define PECU_6W5_1_GAIN1  CYGHWR_HAL_KINETIS_PIN(D, 11, 1, KINETIS_PIN_PULLUP)

#define	PECU_PIN_INIT() \
		{\
			hal_set_pin_function( PECU_LED0_PIN );\
			hal_gpio_pin_ddr_out( PECU_LED0_PIN );\
			hal_set_pin_function( PECU_LED1_PIN );\
			hal_gpio_pin_ddr_out( PECU_LED1_PIN );\
			hal_set_pin_function( EAMP_6W5_1_GAIN0);\
			hal_gpio_pin_ddr_out( EAMP_6W5_1_GAIN0);\
			hal_set_pin_function(EAMP_30W_1_DB36);\
			hal_gpio_pin_ddr_out( EAMP_30W_1_DB36);\
...
#define CCU_6W5_1_MUTE   CYGHWR_HAL_KINETIS_PIN(D, 11, 1, KINETIS_PIN_PULLUP)
#define CCU_6W5_1_GAIN0  CYGHWR_HAL_KINETIS_PIN(D, 11, 1, KINETIS_PIN_PULLUP)
#define CCU_6W5_1_GAIN1  CYGHWR_HAL_KINETIS_PIN(D, 11, 1, KINETIS_PIN_PULLUP)
